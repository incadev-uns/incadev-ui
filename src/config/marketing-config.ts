...
const API_URL = import.meta.env.VITE_MARKETING_API_URL ?? "http://127.0.0.1:8002/api";
const AUTH_API_URL = import.meta.env.VITE_AUTH_SERVICE_URL ?? "http://127.0.0.1:8001/api";
const METRICS_API_URL = import.meta.env.VITE_METRICS_API_URL ?? "http://127.0.0.1:8006/api";
const GENERATION_API_URL = import.meta.env.VITE_GENERATION_API_URL ?? "http://127.0.0.1:8002/api";
const SOCIAL_API_URL = import.meta.env.VITE_SOCIAL_API_URL ?? "http://127.0.0.1:8005/api";
